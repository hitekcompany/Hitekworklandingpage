          ...
          <div className="relative z-10 px-6 py-12 md:px-12 md:py-16 lg:px-20 lg:py-20">
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/20 backdrop-blur-md border border-white/40 mb-8 shadow-lg">
                ...
                <span className="text-sm font-bold text-white">{t('bottom_cta.badge')}</span>
              </div>

              {/* Headline */}
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mb-6">{t('bottom_cta.headline')}</h2>

              {/* Subheadline */}
              <p className="text-base md:text-lg lg:text-xl text-white/95 leading-relaxed mb-10 font-medium">{t('bottom_cta.subheadline')}</p>
