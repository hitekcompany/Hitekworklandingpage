        ...
        <div className="relative overflow-hidden rounded-3xl shadow-2xl">
          ...
          <div className="relative z-10 px-6 py-12 md:px-12 md:py-16 lg:px-20 lg:py-20">
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              {/* Headline */}
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mb-6">Sẵn sàng cho cuộc cách mạng về năng suất làm việc?</h2>
              
              {/* Subheadline */}
              <p className="text-base md:text-lg lg:text-xl text-white/95 leading-relaxed mb-10 font-medium">Đặt lịch live demo ngay để khám phá một giải pháp hoàn toàn khác biệt. </p>
