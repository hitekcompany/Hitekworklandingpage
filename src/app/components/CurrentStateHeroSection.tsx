      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <p className="text-xl lg:text-2xl text-gray-700 leading-relaxed font-medium">
              ...
              <span className="text-blue-600 font-bold">{t('hero.subtitle_highlight')}</span>
              {t('hero.subtitle_end')}
            </p>
            ...
            <div className="space-y-4 pt-4">
              {questions.map((question, index) => (
                <div key={index} className="group bg-white/80 backdrop-blur-md rounded-2xl p-5 border border-gray-200 hover:border-blue-300 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 hover:translate-x-1">
                  <p className="text-base text-gray-700 leading-relaxed group-hover:text-gray-900 transition-colors">{question}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="flex justify-center mt-20">
          <div className="flex flex-col items-center gap-3 animate-bounce">
            <p className="text-sm text-gray-600 font-semibold">{t('hero.scroll_label')}</p>
