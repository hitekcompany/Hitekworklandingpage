            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-3 md:gap-4">
                <div className="flex items-center gap-2 bg-white/20 backdrop-blur-md px-4 py-2 rounded-full border border-white/40 shadow-lg">
                  ...
                  <span className="text-xs md:text-sm font-semibold text-white">{t('cta.trust1')}</span>
                </div>
                <div className="flex items-center gap-2 bg-white/20 backdrop-blur-md px-4 py-2 rounded-full border border-white/40 shadow-lg">
                  <Clock className="w-4 h-4 text-white" />
                  <span className="text-xs md:text-sm font-semibold text-white">{t('cta.trust2')}</span>
                </div>
                <div className="flex items-center gap-2 bg-white/20 backdrop-blur-md px-4 py-2 rounded-full border border-white/40 shadow-lg">
                  <Shield className="w-4 h-4 text-white" />
                  <span className="text-xs md:text-sm font-semibold text-white">{t('cta.trust3')}</span>
                </div>
              </div>
