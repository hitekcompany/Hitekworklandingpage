...
export function CurrentStateSection() {
  ...
  const communicationBubbles = t('current_state.comm_items', { returnObjects: true }) as BubbleItem[];
  const creationBubbles = t('current_state.creation_items', { returnObjects: true }) as BubbleItem[];
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                  ...
                  <div className="relative mb-16">
                    <div className="flex rounded-[1.5rem] overflow-hidden shadow-2xl h-36 border border-gray-200">
                      ...
                      <div className="relative flex-[57] bg-[#1e4bbf] flex items-center justify-center group hover:brightness-110 transition-all duration-300">
                        <div className="text-center relative z-10">
                          ...
                          <p className="text-white/90 text-sm font-bold uppercase tracking-widest drop-shadow">{t('current_state.communication_label')}</p>
                        </div>
                      </div>
                      ...
                      <div className="relative flex-[43] bg-indigo-500 flex items-center justify-center group hover:brightness-110 transition-all duration-300">
                        <div className="text-center relative z-10">
                          ...
                          <p className="text-white/90 text-sm font-bold uppercase tracking-widest drop-shadow">{t('current_state.creation_label')}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="text-center mt-5">
                      <p className="text-gray-500 text-xs font-semibold uppercase tracking-widest">
                        {t('current_state.time_allocation_label')}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-2 mb-5">
                        ...
                        <p className="font-bold text-[#1e4bbf] text-xs uppercase tracking-wider">{t('current_state.communication_label')}</p>
                      </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-2 mb-5">
                        ...
                        <p className="font-bold text-indigo-600 text-xs uppercase tracking-wider">{t('current_state.creation_label')}</p>
                      </div>
            ...
            <div className="order-1 lg:order-2 space-y-10">
              ...
              <div className="bg-white/90 backdrop-blur-xl rounded-2xl p-8 border border-gray-200 shadow-xl">
                <p className="font-bold text-xl text-gray-900 mb-6">{t('current_state.example_label')}</p>
          ...
          <div className="flex justify-center">
            <div className="flex flex-col items-center gap-3">
              <h3 className="text-lg lg:text-xl font-bold text-gray-900">
                {t('current_state.transition_label')}
              </h3>
            </div>
          </div>
        </div>
