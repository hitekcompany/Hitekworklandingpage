        ...
        <div className="relative overflow-hidden rounded-3xl shadow-2xl">
          ...
          <div className="relative z-10 px-6 py-12 md:px-12 md:py-16 lg:px-20 lg:py-20">
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              {/* Subheadline */}
              <p className="text-base md:text-lg lg:text-xl text-white/95 leading-relaxed mb-10 font-medium">
                {t('cta.subtitle')}
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-3 md:gap-4">
                <div className="flex items-center gap-2 bg-white/20 backdrop-blur-md px-4 py-2 rounded-full border border-white/40 shadow-lg">
                  ...
                  <span className="text-xs md:text-sm font-semibold text-white">{t('cta.trust_transparency')}</span>
                </div>
                <div className="flex items-center gap-2 bg-white/20 backdrop-blur-md px-4 py-2 rounded-full border border-white/40 shadow-lg">
                  <Clock className="w-4 h-4 text-white" />
                  <span className="text-xs md:text-sm font-semibold text-white">{t('cta.trust_evidence')}</span>
                </div>
                <div className="flex items-center gap-2 bg-white/20 backdrop-blur-md px-4 py-2 rounded-full border border-white/40 shadow-lg">
                  <Shield className="w-4 h-4 text-white" />
                  <span className="text-xs md:text-sm font-semibold text-white">{t('cta.trust_security')}</span>
                </div>
              </div>
