        ...
        <div className="relative overflow-hidden rounded-3xl shadow-2xl">
          ...
          <div className="relative z-10 px-6 py-12 md:px-12 md:py-16 lg:px-20 lg:py-20">
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              {/* Headline */}
              <h2 className="text-3xl md:text-4xl lg:text-6xl font-bold text-white leading-tight mb-6">Hitek Work giúp bạn quản trị bằng <span className="text-white drop-shadow-lg">dữ liệu thật</span></h2>
